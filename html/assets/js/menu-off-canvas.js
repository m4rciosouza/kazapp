          ...
          '<!-- left off-canvas markup -->' +
            ...
            '<ul class="vertical menu" data-accordion-menu>' +
              '<li style="display: none">' +
                ...
                '</ul>' +
              '</li>' +
              '<li><a href="sobre.html"><i class="fi-info" style="font-size: 20px; color: black"></i> <span class="title-bar-title i18n-off-canvas-4">Sobre</span></a></li>' +
              '<li><a href="redes-sociais.html"><i class="fi-address-book" style="font-size: 20px; color: black"></i> <span class="title-bar-title i18n-off-canvas-4">Redes sociais</span></a></li>' +
              '<li><a href="loja.html"><span class="title-bar-title i18n-off-canvas-4"><i class="fi-shopping-bag" style="font-size: 20px; color: black"></i> Loja</span></a></li>' +
              '<li><a href="mailbox.html"><span class="title-bar-title i18n-off-canvas-4"><i class="fi-mail" style="font-size: 20px; color: black"></i> Mensagens</span></a></li>' +
            '</ul>' +
        '</div>' +
